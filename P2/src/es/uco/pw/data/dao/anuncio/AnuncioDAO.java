package es.uco.pw.data.dao.anuncio;
import es.uco.pw.data.dao.interes.*;
import java.io.File;
...
public class AnuncioDAO {
	...
	public static int save(int identificador, String titulo, String usuario_propietario, String usuario_destinatario, String cuerpo, String fecha_de_publicacion, String type, String estado, String temas){
		...
		try{
			...
			ps.setString(9,temas);
			
			if(comprobarInteres(temas)==0)
			{
				System.out.println("Error al crear el anuncio, el interes no existe");
				return status;
			}
